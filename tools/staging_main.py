...
def main_floor():
    ...
    proc("cushions", "living", b=[11.0, 37.0, 12.0, 43.0], z=1.95, count=3, seed=12, mats=["velvet_teal", "velvet_teal", "wool_mustard"])
...
def exterior():
    ...
    proc("ext_sconce", "vestibule", wall=W("x", 0.0, "-y"), wall_is_face=True, u=13.5, z=6.5, watts=14)
    ...
    proc("heater", "living", pos=[8.0, 49.5, 10.1], length=3.0, on=True, watts=35)
    proc("heater", "living", pos=[18.0, 49.5, 10.1], length=3.0, on=True, watts=35)
