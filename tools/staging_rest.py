...
def second_floor():
    ...
    model("dining_chair_02", (34.0, 31.6, z), "bedroom_b", height_ft=2.7, rot_z=180)
    ...
    model("dining_chair_02", (3.5, 29.6, z), "bedroom_a", height_ft=2.7, rot_z=180)
...
def basement():
    ...
    proc("plate_tree", "gym", pos=[7.0, 2.0, z])
    ...
    model("plastic_crate_01", (37.0, 44.3, z), "storage", length_ft=1.8)
