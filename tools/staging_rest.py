...
def second_floor():
    ...
    proc("small_props", "her_office", kind="printer", pos=[2.8, 25.15, z + 2.4], rot_z=180)   # printer on the credenza, tray toward the wall
    ...
    proc("towel_bar", "kid_bath_sink", wall=W("x", 19.0, "+y"), u=31.5, z=z + 3.8, length=2.5, towels=["towel_white", "towel_stripe"])
