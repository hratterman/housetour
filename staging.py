...
class Stager:
    ...
    def gen_tv_wall(self, e):
        ...
        if e.get("on"):
            screen_m = self.art_material(e.get("seed", 88), emit=1.2)
    ...
    def gen_vanity(self, e):
        ...
        for cx in (x0 + (x1 - x0) * 0.27, x0 + (x1 - x0) * 0.73):
            ...
            objs.append(box_ft(self.uid("mirror_glow"), cx - 1.25, at + 0.02, cx + 1.25, at + 0.06, z + 3.55, z + 6.65, self.mat("lamp_shade"), self.col))
